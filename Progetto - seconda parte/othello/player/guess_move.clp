...
=>
  ...
  (printout t "Counted white cell at row 0, col " ?col ", new count: " (+ ?cnt 1) crlf)
)
...
=>
  ...
  (printout t "Counted white cell at row 7, col " ?col ", new count: " (+ ?cnt 1) crlf)
)
...
=>
  ...
  (printout t "Counted white cell at row " ?row ", col 0, new count: " (+ ?cnt 1) crlf)
)
...
=>
  ...
  (printout t "Counted white cell at row " ?row ", col 7, new count: " (+ ?cnt 1) crlf)
)
